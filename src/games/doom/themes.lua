...
DOOM.THEMES =
{
  ...
  urban =
  {
    ...
    wall_groups =
    {
      ...
      gtd_generic_half_floor = 5
      gtd_generic_half_floor_no_trim = 5
      gtd_generic_half_floor_inverted_braced = 5
      gtd_woodframe = 5
  ...
  hell =
  {
    ...
    wall_groups =
    {
      ...
      gtd_generic_half_floor_no_trim = 15
      gtd_generic_half_floor_inverted_braced = 15
      gtd_woodframe = 15

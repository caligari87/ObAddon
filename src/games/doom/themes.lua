...
DOOM.THEMES =
{
  ...
  tech =
  {
    ...
    wall_groups =
    {
      ...
      gtd_generic_half_floor_no_trim = 10
      gtd_generic_half_floor_inverted_braced = 10
  ...
  urban =
  {
    ...
    wall_groups =
    {
      ...
      gtd_generic_half_floor = 4
      gtd_generic_half_floor_no_trim = 4
      gtd_generic_half_floor_inverted_braced = 4
      gtd_woodframe = 5
  ...
  hell =
  {
    ...
    wall_groups =
    {
      ...
      gtd_generic_half_floor = 12
      gtd_generic_half_floor_no_trim = 12
      gtd_generic_half_floor_inverted_braced = 12
      gtd_woodframe = 15

...
- Attempted to fix the issue vistas still being rendered on mostly indoor maps but are too low of a height for indoors to connect windows to. (still needs more fixing)

Affected files:
                games/doom/fabs/pic/gtd_pic_hell_throne.wad & .lua
                               /decor/gtd_decor_hell.wad & .lua
                               /switch/tight.wad & .lua
                               /switch/tight_UNFINISHED.wad <---[[ REMOVED ]]
                               /window/gtd_window_bay.wad & .lua
...
- Removed a broken flat reference in the bodies-inside-the-wall hell diagonal.
- Removed the bright light sector in one of the tech overhangs, doesn't look good on occasion.
- Raised some sectors in the crack-of-doom fab as Oblige still frequently caused the lava area to disappear.
- Attempted to fix the issue of one of the tech walls often becoming texture-misaligned when intersecting with a ceiling light.
...
Affected files:
                ...
                modules/procedural_gotcha.lua
                games/doom/fabs/exit/gtd_generic_immersive_exit.wad
                               /decor/dh_lamp.lua
                               /decor/ruins.lua
                               /decor/blob_lamp.lua
                               /picture/gtd_pic_hell_alcoves.lua
                               /wall/garrett_wall_of_pain_diagonal.wad
                               /wall/gtd_wall_tech_overhangs.wad
                               /decor/gtd_infestation_crackofdoom.wad
                               /wall/gtd_wall.wad
